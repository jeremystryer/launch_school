...
// The switch statement on lines 37 - 41 does not use a break statement for each case. Therefore, if a case returns true, there is a fall through to the cases that follow it. This only affects case 1 and case 20, since the default case has no cases that follow it.

// The fix would be to include a break statement for each of the first two cases:
