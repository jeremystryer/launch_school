...
// On line 13, Array.prototype.sort() is invoked on nums, the array of scores passed in as an argument to median. However, not callback function is passed into sort() and the default process for sort() is to order
// elements based on their string values, not numerical value. Instead of [89, 72, 100] being sorted as [72, 89, 100], it is sorted as [100, 72, 89].
