...
// The function isValidName uses the shortcut \w in regex in order to test whether the name only contains letters. However \w matches letters, numbers, and underscores.
// To fix the issue, use the following regex which will check that first name and last name each begin with a capital letter followed by lowercase letters and with one space between first name and last name.
//  function isValidName(name) {
