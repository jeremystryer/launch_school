...
// On lines 44, the random() function is invoked three times and returns three arrays. Using the + operator join these arrays results in a string being returned. That string is then assigned to the constant dishName.
// On line 47, Array.prototype.join() is called on dishName is a string, join() cannot be invoked on it. The same issue arises for lines 45 and 48.
// To fix the issue, Array.prototype.concat() should be used as below.
