...
// On line 7, the variable ladder is assigned an empty string. However, this statement is not followed by a semicolon. Javascript does automatic semicolon insertion, which results in:

// let ladder = ''['head', 'heal', 'teal', 'tell', 'tall', 'tail'].forEach...

// As a result, the array is treated as an accessor on the empty string. Since the empty string does not have this array property, it returns undefined and forEach is then called on undefined, which throws an error.
