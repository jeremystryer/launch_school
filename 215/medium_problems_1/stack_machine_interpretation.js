...
// RULES
// stack initialized to [], register initialized to 0
// given a string
// string contains either numbers or command
// number (n) is value for register
// command can be push, add, subt, mult, etc
// command print will console.log register value
// all commands are for integer operations
...
// switch command
// case regex for number
// case for each other command
